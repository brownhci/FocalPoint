...
{
    internal class AdvancedDisolve_ParticlesUnlitShader : BaseShaderGUI
    {
        // Properties
        ...
        public override void MaterialChanged(Material material)
        {
            ...
            SetMaterialKeywords(material, null, UnityEditor.Rendering.Universal.ShaderGUI.ParticleGUI.SetMaterialKeywords);
        ...
        public override void DrawAdvancedOptions(Material material)
        {
            EditorGUI.BeginChangeCheck();
            {
                ...
                UnityEditor.Rendering.Universal.ShaderGUI.ParticleGUI.DoVertexStreamsArea(material, m_RenderersUsingThisMaterial);
            }

Shader "Outlines/BackFaceOutlines" {
    Properties{
        _OutlineWidth("OutlineWidth", Float) = 1 // The amount to extrude the outline mesh
        _OutlineColor("OutlineColor", Color) = (1, 1, 1, 1) // The outline color
        _DepthOffset("Depth offset", Range(0, 1)) = 0 // An offset to the clip space Z, pushing the outline back
        _OutlineDot("OutlineDot", Float) = 1 // identity tag

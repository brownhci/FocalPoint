...
namespace Portalble {
    ...
    public class IndicatorManager : MonoBehaviour {
        ...
        public float trackStartDistance = 600f;
        public float soundCylinderRadius = 0.1f;
        // public float trackOffset = 50f;
        ...
        void RefreshTrackingList() {
            // Debug.Log("List length:" + m_indicators.Count + " and map:" + m_trackingObjects.Count);
        ...
        public void toggleSound() {
           ...
           // GlobalTaskManager.useSound = m_configs.useSound;
            foreach (IDistanceIndicator di in m_indicators) {
                di.UpdateConfig(m_configs);
            }
        }

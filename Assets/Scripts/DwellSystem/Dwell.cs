...
namespace Portalble {
    ...
    public class Dwell {
        ...
        /*
        private const int DWELL_COOLDOWN_BUFFER = 100;
        private const int DWELL_ON_BUFFER = 50;
        private const int DWELL_OFF_BUFFER = 90;
        private const int DWELL_BUTTON_OFF_BUFFER = 50;
        private const float FINGER_DWELL_TD = 13.0f;
        private const float AR_DWELL_TD = 10.1F;
        private const float SCRN_DWELL = 13.1F;*/
        ...
        public void doUpdate(Vector3 position) {  
            ...
            if (isStable()) {
                ...
                //Debug.Log("dwellTrigerCounter" + dwellTrigerCounter);
                /* check on and off */
                if (!m_isTrigger) {
